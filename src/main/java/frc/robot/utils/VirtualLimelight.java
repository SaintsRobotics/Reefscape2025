...
public class VirtualLimelight {
    ...
    public VirtualLimelight(String name) {
        ...
        m_listenerHandle = NetworkTableInstance.getDefault().getTable(m_table).addListener(EnumSet.of(Kind.kValueAll), new Listener());
    }
    ...
    public void update() {
        ...
        assert(botpose_orb_wpiblue.length == VirtualLimelightConstants.kbotpose_orb_wpiblue_header_size + VirtualLimelightConstants.kValsPerFiducial * tc);
